...
def initiate_payment(request):
    if request.method == 'POST':
        ...
        data = {
                ...
                "AccountReference": "as-ils-92",
                "TransactionDesc": "Asus testing"
            }
        ...
        if "ResponseCode" in json_resp:
            ...
            if code == '0':
                ...
                crid = json_resp["CheckoutRequestID"]
                logger.info(f"{mid} {crid}")
            else:
                logger.error(f"Error while initiating {code}")
